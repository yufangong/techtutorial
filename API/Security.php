...
{
    /**key is one of the ciphers supported by OpenSSL (@see openssl_get_cipher_methods()).
     * The value is an array of tw
     ...
     *
     * In each element, the o integers, the first is the cipher's block size in bytes and the second is
